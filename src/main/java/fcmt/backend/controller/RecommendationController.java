 ...
 public ResponseEntity<RecommendResponseDto>
 getRecommendation(@RequestHeader("Authorization") String authHeader) {
 ...
 public ResponseEntity<RecommendResponseDto> interest(@RequestHeader("Authorization")
 String authHeader) {
 String accessToken = authHeader.substring(7);
